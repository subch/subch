...
export const TILE_ICONS = {
  ...
  'go-fish': '<svg viewBox="0 0 100 100"><path d="M18 52 C30 36 48 30 62 38 L80 26 L76 50 L80 74 L62 62 C48 70 30 64 18 52 Z" fill="var(--p2)" stroke="rgba(0,0,0,.3)" stroke-width="2.5"/><circle cx="36" cy="48" r="4" fill="var(--card-face)"/><path d="M12 30 q10 4 0 10 M10 62 q12 2 4 10" stroke="var(--accent)" stroke-width="4" fill="none" stroke-linecap="round"/></svg>',
  'memory-match': '<svg viewBox="0 0 100 100"><rect x="12" y="18" width="36" height="52" rx="6" fill="var(--card-back)" stroke="var(--card-back-2)" stroke-width="2.5" transform="rotate(-8 30 44)"/><rect x="50" y="26" width="36" height="52" rx="6" fill="var(--card-face)" stroke="rgba(0,0,0,.3)" stroke-width="2" transform="rotate(7 68 52)"/><text x="66" y="62" text-anchor="middle" font-family="var(--font-display)" font-weight="700" font-size="26" fill="var(--card-red)" transform="rotate(7 68 52)">?</text></svg>',
